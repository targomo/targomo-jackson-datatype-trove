...
public class TLongIntMapSerializer extends BaseTroveMapSerializer<TLongIntMap> implements ContextualSerializer
{
    TLongIntMapSerializer(JavaType type, BeanProperty property,
    ...
    protected JsonSerializer<TLongIntMap> withResolved(BeanProperty prop,
                                                      JsonSerializer<Object> newKeySerializer,
                                                      JsonSerializer<Object> newValueSerializer) {
        return new TLongIntMapSerializer(mapType, prop,
                newKeySerializer, valueTypeSerializer, newValueSerializer);
    }
    
    @Override
    void serializeEntries(TLongIntMap map, final JsonGenerator jgen, final SerializerProvider provider)
    ...
    @Override
    public boolean isEmpty(TLongIntMap value) {
